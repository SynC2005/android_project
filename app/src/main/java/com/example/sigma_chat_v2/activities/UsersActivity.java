...
import com.example.sigma_chat_v2.adapters.UsersAdapter;
import com.example.sigma_chat_v2.databinding.ActivityUsersBinding;
import com.example.sigma_chat_v2.listeners.UserListener;
...
public class UsersActivity extends BaseActivity implements UserListener {
    ...
    private void showErrorMessage() {
        binding.textErrorMessage.setText(String.format("%s", "I'm So Lonely"));
